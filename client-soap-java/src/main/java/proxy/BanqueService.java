...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "ConservationEuroToDH", targetNamespace = "http://ws/", className = "proxy.ConservationEuroToDH")
    @ResponseWrapper(localName = "ConservationEuroToDHResponse", targetNamespace = "http://ws/", className = "proxy.ConservationEuroToDHResponse")
    @Action(input = "http://ws/BanqueService/ConservationEuroToDHRequest", output = "http://ws/BanqueService/ConservationEuroToDHResponse")
    public double conservationEuroToDH(
